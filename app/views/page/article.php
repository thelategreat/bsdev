<div class="article">
	...
	<?php if( count($images)) { ?>
			<img src="<?=$images[0]?>" style="width: 150px; margin: 10px; float: right" />
	<?php } ?>
...
<div style="float: right">
	...
	<a href="#" title="Share this on facebook"><img src="/img/icons/icon_facebook.png"/></a>
	<!-- http://twitter.com/home?status=Microsoft+Mice+Made+in+Chinese+Youth+Sweatshops%3F%3A+http%3A%2F%2Fbit.ly%2Fdvk9yn -->
	<a href="#" title="Share this on twitter"><img src="/img/icons/icon_twitter.png"/></a>
</div>