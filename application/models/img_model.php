...
class Img_model extends CI_Model
{
  ...
  public function __construct()
  {
    ...
    $this->path = BASEPATH."../public/media/";
  ...
  */
  ...
  public function get_img($raw = TRUE)
  {
    ...
    $cache_image = $this->path.$this->img_pre.$this->cache_folder.'/'.$this->img_name.'_'.$this->res_prop['width'].'x'.$this->res_prop['height'].'.'.$this->img_ext;
