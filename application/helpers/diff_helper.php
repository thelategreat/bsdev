...
/**
 * Compare two strings of lines (EOL=\n) and return a string in standard diff format
 *
 * @param  $old the original string of lines (EOL=\n)
 * @param  $new the new string to compare against (EOL=\n)
 * @return a string in standard diff format
 */
